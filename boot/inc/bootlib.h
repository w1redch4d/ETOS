...
#define BOOT_ENTRY_DEBUGGER_CONNECTED 0x00004000
...
(*PBOOT_OPTION_CALLBACK_DEVICE) (
    ...
    OUT PBOOT_ENTRY_OPTION *AdditionalOptions
    );
...
#define ENVIRONMENT_STATE_HANDLE_DOUBLE_FAULTS 0x00000002

extern ULONG BlpEnvironmentState;
